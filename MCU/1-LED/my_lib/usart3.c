...
void uart3_init(u32 bound)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB| RCC_APB2Periph_AFIO, ENABLE);//ʱ��GPIOB��USART3
	...
	GPIO_Init(GPIOB, &GPIO_InitStructure);
	 ...
	 NVIC_InitStructure.NVIC_IRQChannel = USART3_IRQn;
		...
		NVIC_Init(&NVIC_InitStructure);	//锟斤拷锟斤拷NVIC_InitStruct锟斤拷指锟斤拷锟侥诧拷锟斤拷锟斤拷始锟斤拷锟斤拷锟斤拷NVIC锟侥达拷锟斤拷USART1
